    ...
    return (
        <div className="animate-fade-in-up">
            <div className="relative mb-8">
                <button onClick={onClose} className="absolute left-0 top-1/2 -translate-y-1/2 p-2 rounded-full hover:bg-brand-secondary-100 transition-colors interactive-scale">
